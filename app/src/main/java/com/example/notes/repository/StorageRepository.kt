...
class StorageRepository() {
    ...
    fun getUserNotes(
        ...
        try {
            snapshotStateListener = notesRef.orderBy("timestamp")
    ...
    fun addNote(
        ...
        val note = Notes(userId,title,description,timestamp,color,documentId)

        notesRef.document(documentId).set(note).addOnCompleteListener { result ->
