...
import com.example.noteapp2.domain.use_cases.AddUseCase
import com.example.noteapp2.domain.use_cases.GetNoteByIdUseCase
    ...
    private fun getNoteById() = viewModelScope.launch {
        getNoteByIdUseCase(noteId).collectLatest { note ->
            state = state.copy(
                ...
                isBookmark = note.isBookMarked, createdDate = note.createdDate
            )
        }
    }
